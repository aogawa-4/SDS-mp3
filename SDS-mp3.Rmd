...
#   + 
#     geom_text(aes(x = 40, y = 200, label = "Maple Syrup Yeild"),  color = "orange") +
#     geom_text(aes(x = 40, y = 150, label = "Tempreture Difference"), color = "blue")
#   
# } 
...
```{r}
ggplot(data, aes(x = )) + geom_bar() + geom_line()
```
